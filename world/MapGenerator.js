...
export function generateMainTown(width, height) {
  ...
  const fences = [
    new StaticObject({ type: 'fence', x: center.x - 28, y: center.y - 10, radius: 1, spriteId: 'fence', category: 'terrain', collision: true, interaction: null, logicalShape: { kind: 'line', tiles: [[0, 0]] } }),
    new StaticObject({ type: 'fence', x: center.x - 27, y: center.y - 10, radius: 1, spriteId: 'fence', category: 'terrain', collision: true, interaction: null, logicalShape: { kind: 'line', tiles: [[0, 0]] } }),
    new StaticObject({ type: 'fence', x: center.x - 26, y: center.y - 10, radius: 1, spriteId: 'fence', category: 'terrain', collision: true, interaction: null, logicalShape: { kind: 'line', tiles: [[0, 0]] } }),
    new StaticObject({ type: 'fence', x: center.x + 12, y: center.y + 13, radius: 1, spriteId: 'fence', category: 'terrain', collision: true, interaction: null, logicalShape: { kind: 'line', tiles: [[0, 0]] } }),
    new StaticObject({ type: 'fence', x: center.x + 13, y: center.y + 13, radius: 1, spriteId: 'fence', category: 'terrain', collision: true, interaction: null, logicalShape: { kind: 'line', tiles: [[0, 0]] } }),
  ];
